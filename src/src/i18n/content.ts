...
export const dirEn: Record<string, string> = {
  '柔性电子微飞行器': 'Flexible Electronic Microflyers',
...
export const memberEn: Record<string, MemberEn> = {
  ...
  'xie-hongwei': { name: 'Hongwei Xie', role: 'Ph.D. Student', degree: '2026', project: 'Flexible electronic microfliers (mass-shifting microgliders with sensing–communication–actuation); flight-stability mechanisms of microgliders; wireless networking for microflyers', bio: 'Leads mass-shifting microgliders, flight-stability mechanisms, and wireless networking; contributes to pressure-array sensing (Y. Lü), UAV propeller health monitoring (Y. Han), morphable microfliers (X. Geng), and bio-inspired microfliers (Y. Liu).' },
  ...
  'ling-jinghui': { name: 'Jinghui Ling', role: 'Ph.D. Student', degree: '2023', project: 'Flexible PZT thin-film delamination and piezoelectric sensor fabrication', bio: 'Works on flexible PZT thin-film delamination and piezoelectric sensor fabrication; contributes to micron-scale self-morphing microflyer fabrication and laser-induced-graphene 3D self-assembled flyers (with K. Li).' },
  'pan-jinyu': { name: 'Jinyu Pan', role: 'Master Student', degree: '2025', project: 'Flexible multimodal sensor fabrication', bio: 'Works on flexible multimodal sensor fabrication; contributes to micron-scale self-morphing microflyer fabrication (K. Li).' },
...
export const mediaEn: Record<string, { title?: string; excerpt?: string; outlet?: string }> = {
  ...
  '2025-tsinghua-returnee': { outlet: 'Tsinghua University', title: 'Kan Li: tackling the “chokepoint” challenges of microflyers', excerpt: 'Tsinghua Alumni Association “Returned Tsinghua” series: focusing on microflyer research aligned with national needs.' },
};
